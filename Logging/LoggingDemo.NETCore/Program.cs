...
public static class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        ServiceProvider = new ServiceCollection()
            ...
            {
                optionsAction.UseSqlServer(@"data source=localhost;initial catalog=WideWorldImporters;User Id=sa;Password=Password12!;MultipleActiveResultSets=True;App=EntityFramework;TrustServerCertificate=true", sqlServerOptions =>
                {
